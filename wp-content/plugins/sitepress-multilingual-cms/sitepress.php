 ...
 * Description: WPML Multilingual CMS | <a href="https://wpml.org">Documentation</a> | <a href="https://wpml.org/version/wpml-4-6-14/">WPML 4.6.14 release notes</a>
...
if ( isset( $wpml_setup['current-step'] ) && ( $wpml_setup['current-step'] == 'license' ) ) {
$wpml_setup['current-step'] = 'translation';
update_option( 'WPML(setup)', $wpml_setup );
}
update_option( 'otgs_share_local_components', ['wpml'=>'0'] );
...
define( 'ICL_SITEPRESS_VERSION', '4.6.14' );
