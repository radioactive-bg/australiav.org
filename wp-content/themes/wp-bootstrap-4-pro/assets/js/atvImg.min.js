...
function atvImg(){function e(e,t,n,i,a,s){var c=o.scrollTop||r.scrollTop,l=o.scrollLeft,d=t?e.touches[0].pageX:e.pageX,u=t?e.touches[0].pageY:e.pageY,h=n.getBoundingClientRect(),v=n.clientWidth||n.offsetWidth||n.scrollWidth,p=n.clientHeight||n.offsetHeight||n.scrollHeight,m=320/v,f=0.52-(d-h.left-l)/v,g=0.52-(u-h.top-c)/p,k=u-h.top-c-p/2,C=d-h.left-l-v/2,E=(f-C)*(0.07*m),y=(k-g)*(0.1*m),S="rotateX("+y+"deg) rotateY("+E+"deg)",I=Math.atan2(k,C),T=(180*I)/Math.PI-90;0>T&&(T+=360),-1!=n.firstChild.className.indexOf(" over")&&(S+=" scale3d(1.02,1.02,1.02)"),(n.firstChild.style.transform=S),(s.style.background="linear-gradient("+T+"deg, rgba(0,0,0,"+((u-h.top-c)/p)*0.4+") 0%,rgba(0,0,0,0) 80%)"),(s.style.transform="translateX("+f*a-0.1+"px) translateY("+g*a-0.1+"px)");for(var w=a,F=0;a>F;F++)(i[F].style.transform="translateX("+f*w*((2.5*F)/m)+"px) translateY("+g*a*((2.5*F)/m)+"px)"),w--}
...
return!0;if(!deviceIsIOS4){if(n.identifier===this.lastTouchIdentifier)
return e.preventDefault(),!1;(this.lastTouchIdentifier=n.identifier),this.updateScrollParent(t)}}
