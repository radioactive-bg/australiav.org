...
if(!$disable_layout) {
?>
<section id="<?php echo ($custom_id ); ?>" class="section-content-img-within <?php echo ($container ); ?> <?php echo ($custom_class ); ?>">
    <div class="row mx-0">
        <div class="section card w-100" style="<?php if ($background_image):?>background-image: url('<?php echo $background_image; ?>');<?php endif; ?><?php if ($background_color):?>background-color:<?php echo $background_color;?>;<?php endif; ?>">
            <div class="card-body d-flex flex-wrap py-5 px-3 px-lg-4 <?php echo ($image_align =='text-center') ? 'align-items-center' : ''; ?>">
                <?php if ($image):?>
