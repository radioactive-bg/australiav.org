...
<div class="row">
	<?php if ( $layout_title || $label ): ?>
		<div class="col-12 col-lg col-xl-5 align-self-center mb-5 mb-lg-0">
			<?php if ( $label ):?>
			...
			<?php endif;?>
			<?php if ( $description ):?>
				<div class="section-desc"><?php echo $description; ?></div>
			<?php endif;?>
		</div>
	<?php endif;?>
...
<?php // check if the repeater field has rows of data
	...
	echo	 '<div id="testimonial_carousel_1" class="carousel slide col-lg col-xl-7" data-ride="carousel">
	...
	<div class="carousel-item slide-item-<?php echo $i;?> <?php if($i == 0) echo 'active';?>" role="option">
		<div class="row align-items-center justify-content-center;" style="flex-grow: 1;">
			<div class=" col-md-8 mx-auto text-center">
				...
				<?php endif;?>
				<?php if( $slide_title ): ?>
					<h3 class="slide-title h4 mt-0 mb-0"><?php echo $slide_title; ?></h3>
				<?php endif; ?>
	...
	<li class="" style="text-indent:0" data-target="#testimonial_carousel_1" data-slide-to="<?php echo $i;?>" class="<?php if($i == 0) echo 'active';?>">
	...
	echo '<a class="carousel-control-prev" href="#testimonial_carousel_1" role="button" data-slide="prev">
				<span class="carousel-control-prev-icon" aria-hidden="true"></span>
				<span class="sr-only">Previous</span>
			</a>
			<a class="carousel-control-next" href="#testimonial_carousel_1" role="button" data-slide="next">
