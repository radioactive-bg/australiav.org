<div class="zf-templateWidth"><form action='https://forms.zohopublic.com/arpayhks/form/HKSPricesEN/formperma/19TPM4TqyKdA_oklhwHhpuO33fMZAalFapSsnNFSS4U/htmlRecords/submit' name='form' method='POST' onSubmit='javascript:document.charset="UTF-8"; return zf_ValidateAndSubmit();' accept-charset='UTF-8' enctype='multipart/form-data' id='form'><input type="hidden" name="zf_referrer_name" value=""><!-- To Track referrals , place the referrer name within the " " in the above hidden input field -->
...
<ul class="zf-tempHeadBdr"><li class="zf-tempHeadContBdr"><h2 class="zf-frmTitle"><em>HKS Prices</em></h2>
...
<span> <input type="text" name="SingleLine3" checktype="c1" value="" maxlength="255" fieldType=1 placeholder=""/></span> <p id="SingleLine3_error" class="zf-errorMessage" style="display:none;">Invalid value</p>
</div><div class="zf-clearBoth"></div></li><!---------Single Line Ends Here---------->
<!---------Dropdown Starts Here---------->
<li class="zf-tempFrmWrapper zf-small"><label class="zf-labelName">
Monthly volume from the desired product
</label>
<div class="zf-tempContDiv">
...
<div class="zf-tempContDiv">
<p class="zf-instruction">Please describe in more details if needed about your order</p>
...
<label for="DecisionBox" class="zf-labelName">I agree with the Privacy Policy
</label>
...
<ul><li class="zf-fmFooter"><button class="btn btn-primary w-100 zf-submitColor" >Submit</button></li></ul></div><!-- 'zf-templateWrapper' ends --></form></div><!-- 'zf-templateWidth' ends -->
<script type="text/javascript">var zf_DateRegex = new RegExp("^(([0][1-9])|([1-2][0-9])|([3][0-1]))[-](Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec|JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC)[-](?:(?:19|20)[0-9]{2})$");
var zf_MandArray = [ "SingleLine", "PhoneNumber_countrycode", "Email"]; 
var zf_FieldArray = [ "SingleLine3", "Dropdown", "SingleLine", "PhoneNumber_countrycode", "Email", "SingleLine2", "MultiLine", "DecisionBox"]; 
